...
INSERT INTO ticket (pnr, username, entry_station, exit_station, fare, booking_details) VALUES
                                                                                           ('PNR001', 'john_doe', 'S1', 'S4', 50, 'Booked via App'),
                                                                                           ('PNR002', 'jane_smith', 'S2', 'S5', 60, 'Counter Booking'),
                                                                                           ('PNR003', 'mark_taylor', 'S3', 'S6', 45, 'Online Payment');
...
INSERT INTO metro_stop (route_id, st_code, stop_order, platform) VALUES
                                                                     ...
                                                                     ('R6', 'S3', 9, 3),
                                                                     ('R6', 'S2', 10, 2);
INSERT INTO passenger (user_id, pnr) VALUES
                                         ('U001', 'PNR001'),
                                         ('U002', 'PNR002'),
                                         ('U003', 'PNR003');
